...
export default function Reflection() {
  ...
  return (
    <div className="space-y-4" aria-label="reflection prompts">
      <h2 className="text-xl font-semibold">Reflection</h2>
      <div>
        <label className="block font-medium" htmlFor="weekly">Was I proactive or reactive?</label>
        <textarea
          id="weekly"
      ...
      <div>
        <label className="block font-medium" htmlFor="monthly">How aligned were my tasks with my mission and values?</label>
        <textarea
          id="monthly"
          className="border w-full p-2 h-24"
          value={monthly}
